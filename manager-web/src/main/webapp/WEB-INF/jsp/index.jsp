...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="${contextPath}/resources/img/profile_small.jpg" /></span>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row content-tabs">
            ...
            <a href="${contextPath}/logout" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
        </div>
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${contextPath}/content" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
        <div class="footer">
...
//        $ma.accordion({animate:true,fit:true,border:false});
        $.post("${contextPath}/menuList", {}, function(rsp) {
            $.each(rsp,function(i,e){
                var menulist ="<li><a href='#'><i class='fa "+e.iconCls+"'></i><span class='nav-label'>"+e.name+"</span>";
                if(e.child && e.child.length>0){
                    menulist+="<span class='fa arrow'></span></a><ul class='nav nav-second-level'>";
                    $.each(e.child,function(ci,ce){
                        menulist+="<li><a class='J_menuItem' href='"+ce.url+"' data-index='0'>"+ce.name+"</a></li>";
                    });
                }
                menulist+="</ul></li>";
//                $ma.accordion('add', {
...
<script src="${contextPath}/resources/js/hplus.min.js?v=4.1.0"></script>
<script src="${contextPath}/resources/js/contabs.min.js"></script>
